...
class EmbedID(link.Link):
    ...
    """Custom implementation of EmbedID, with a different weight initialization.
    All initial values lie between 0 and 1.
    ...
    def __init__(self, in_size, out_size):
        ...
        # self.W.data[...] = numpy.random.rand(in_size, out_size)
